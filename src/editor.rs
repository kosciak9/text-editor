...
impl Editor {
            ...
            Key::Ctrl('q') => {
                if self.quit_times > 0 && self.document.is_dirty() {
                    self.status_message = StatusMessage::from(format!(
                        "[WARNING]: File hasunsaved changes. Press Ctrl + Q {} more times to quit.",
                        self.quit_times
                    ));
                    self.quit_times -= 1;
                    return Ok(());
    ...
    fn save(&mut self) {
        ...
        if self.document.save().is_ok() {
            ...
            self.status_message = StatusMessage::from("Error occured during file save.".to_string())
        }
    }
    ...
    fn draw_status_bar(&self) {
        ...
        Terminal::set_background_color(STATUS_BG_COLOR);
        Terminal::set_foreground_color(STATUS_FG_COLOR);
        println!("{}\r", status);
